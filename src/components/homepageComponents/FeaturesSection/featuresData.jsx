...
export const features = [
  ...
  {
    title: "Download metadata embedded in images",
    description:
      "Embed metadata directly into images for seamless sharing and storage. Ensure your data travels with your images, maintaining context and accessibility.",
    icon: <Bolt className="h-6 w-6 text-blue-400" />,
    image: IntegrationImage,
  }
]; 